...
export const Private = getThemeProperties('crimson');
Private['--color-primary-50'] = '60 142 174';
Private['--color-primary-100'] = '60 142 174';
Private['--color-primary-200'] = '60 142 174';
Private['--color-primary-300'] = '60 142 174';
Private['--color-primary-400'] = '60 142 174';
Private['--color-primary-500'] = '60 142 174';
Private['--color-primary-600'] = '60 142 174';
